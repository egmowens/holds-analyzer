...
In this project, Nathan Cosgray extracted and processed data on holds from our ILS and I used it to create prediction models for when library patrons would receive their holds. Together, we analyzed the implications of hold queue processing for our library service levels. Our LITA Forum presentation, which provides some context, can be found here: http://connect.ala.org/node/213947
...
Note: the results with 500 instances will be unimpressive; in our real work we used 2.2 to 3.5 million instances!
...
This code is basic and doesn't go into the analysis surrounding our number crunching. If this isn't enough to work with yet, know that we are still working on the project and will publish more details once we've amassed more year-over-year data, i.e. after Spring 2014.
